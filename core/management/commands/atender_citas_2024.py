...
class Command(BaseCommand):
    help = 'Atiende las citas confirmadas de 2024, prescribe recetas y deriva pacientes según diagnóstico grave.'

    def handle(self, *args, **options):
        random.seed(44)
        citas_confirmadas = list(Cita.objects.filter(estado='confirmada', fecha__year=2024))
        total_atendidas = 0
        total_recetas = 0
