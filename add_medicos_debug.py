...
print(f"Rol de Médico: {'creado' if created else 'ya existía'}")
...
print(f"Se procesarán {len(especialidades_medicos)} especialidades")
...
for esp_data in especialidades_medicos:
    ...
    try:
        ...
        print(f"Creando {cantidad} médicos para la especialidad: {nombre_especialidad}")
        ...
        for i in range(cantidad):
            ...
            print(f"  Creando médico: {nombres} {apellidos} (DNI: {dni}, CMP: {cmp})")
            ...
            try:
                ...
                print(f"  Usuario {'creado' if created_user else 'actualizado'}: {usuario.nombres} {usuario.apellidos}")
                ...
                print(f"  Error al crear usuario/médico: {str(e)}")
                errores += 1
